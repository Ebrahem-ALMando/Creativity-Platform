        ...
        <footer className="footer" id="who-are-we">
            ...
            <div className="footer">
                ...
                <div className="box">
                    ...
                    <a
                        className="con"
                        href="mailto:ebrahemalmando2001@gmail.com"
                    >
                        ebrahemalmando2001@gmail.com
                    </a>
                </div>
                <div className="box">
                    <h1>معلومات </h1>
                    <a href="resources/js/components/UserHome/Footer/Footer">معلومات عنا</a>
                    <a href="resources/js/components/UserHome/Footer/Footer">اسئلة مكررة</a>
                    <a href="#">انضم الينا</a>
